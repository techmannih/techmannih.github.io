    ...
    >
      ...
      >
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          A buiding enthusiastic Full Stack Dev , passionate about Javascript development .Seeking to advance a grownig tech career as a Software Development Engineer in a competitive environment
        </p>
